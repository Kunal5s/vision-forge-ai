    ...
    const handleGenerateImages = async () => {
        ...
        if (result.success && result.images) {
            const newPages = result.images.map(img => ({
                ...
                styleName: 'Classic Black', // Default style
            }));
            replace(newPages);
                        ...
                        <ScrollArea className="w-full">
                            <div className="flex space-x-4 pb-4">
                                ...
                                <div className="flex items-center justify-center w-[220px] shrink-0">
                                    <Button type="button" variant="outline" onClick={() => append({ imageUrl: '', caption: '', imagePrompt: 'manual upload', styleName: 'Classic Black' })} disabled={isPublishing || fields.length >= 50}>
