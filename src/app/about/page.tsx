    ...
    <main className="container mx-auto py-12 md:py-16 px-4">
      <header className="text-center mb-12">
        <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight text-foreground mb-4">
          About Imagen <span className="text-primary">BrainAi</span>
        </h1>
      ...
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        <section>
          <Card className="bg-muted/50 border">
            <CardHeader>
              <CardTitle className="text-2xl md:text-3xl font-semibold text-foreground text-center">What Our AI Image Generator Offers</CardTitle>
            </CardHeader>
        ...
        <section>
          <h2 className="text-2xl md:text-3xl font-semibold text-foreground mb-4">Our Vision for the Future</h2>
          <p className="text-base md:text-lg text-foreground/80 mb-4">
