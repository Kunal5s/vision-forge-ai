...
import { getStoryBySlug, updateStoryAction, deleteStoryAction } from '@/app/admin/dashboard/stories/edit/[slug]/actions';
import { generateStoryImagesAction } from '@/app/admin/dashboard/stories/create/actions';
...
export default function EditStoryForm({ slug }: EditStoryPageProps) {
        ...
        const fetchStory = async () => {
            ...
            if (fetchedStory) {
                ...
                if (clientPages.length > 0 && clientPages[0].styleName) {
                 ...
                 toast({ title: 'Error', description: 'Story not found or could not be loaded.', variant: 'destructive' });
            }
            setIsLoading(false);
        };
        fetchStory();
