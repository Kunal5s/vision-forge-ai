...
export function AdminLogin() {
  ...
  const handleLogin = async (formData: FormData) => {
    ...
    if (error) {
      ...
      setIsOpen(false);
      // Let the action handle the redirect
      // This re-fetches user state after successful login.
      getUser().then(setUser);
    }
  };
  ...
  const handleLogout = async () => {
    ...
    // Redirect is handled by the logout action, but we update state immediately.
  };
